...
insert into customer values ("C001", "김서형", "D", 1, "서울시 강남구 논현동", "010-7598-4533"), -- D,P,G,S,B 각 등급별 5명 / 총 25명
...
"YN BANK 직원 어려분 코로나 19 때문에 은행이 부도 위기에 처했지만, 
여러분의 노고만이 회사를 살리는 유일한 길입니다. 
