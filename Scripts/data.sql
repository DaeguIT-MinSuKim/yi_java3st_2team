...
("C006", "김태리", "P", 2, "경기도 안양시 동안구 평안동", "010-6356-7977"),
("C007", "김향기", "P", 2, "경기도 수원시 권선구 세류동", "010-7722-3140"),
("C008", "강소라", "P", 2, "경기도 용인시 처인구 마평동", "010-1325-0314"),
("C009", "한효주", "P", 2, "전주시 완산구 삼천동", "010-5972-2310"),
("C010", "박보영", "P", 2, "광주광역시 서구 치평동", "010-3652-1234"),
("C011", "한가인", "G", 3, "광주광역시 광산구 우산동", "010-7701-4322"),
("C012", "배두나", "G", 3, "부산광역시 동래구 안락동", "010-3265-1114"),
("C013", "김설현", "G", 3, "부산광역시 금정구 서동", "010-0311-1773"),
("C014", "박예진", "G", 3, "부산광역시 금정구 금사동", "010-8990-9314"),
("C015", "오연수", "G", 3, "부산광역시 부산진구 연지동", "010-5441-6593"),
("C016", "차은우", "S", 4, "부산광역시 남구 용당동", "010-6265-7891"),
("C017", "박지민", "S", 4, "부산광역시 영도구 동삼동", "010-6890-9835"),
("C018", "전정국", "S", 4, "제주시 애월읍", "010-3200-7925"),
("C019", "민윤기", "S", 4, "대구시 수성구 황금동", "010-3210-7900"),
("C020", "김태형", "S", 4, "대구시 수성구 범어동", "010-6040-1018"),
("C021", "정윤호", "B", 5, "대구시 수성구 만촌동", "010-4550-1766"),
("C022", "최창민", "B", 5, "대구시 달서구 성당동", "010-3468-7772"),
("C023", "한예슬", "B", 5, "대구시 서구 내당동", "010-1358-3165"),
("C024", "임예진", "B", 5, "대구시 중구 삼덕동", "010-3050-4700"),
...
('2931332000000040','C002','B002',222,now(),10000000,null,'B007','293133-11-000004');
...
('C003','B008','C002'),('C001','B008','C003'),('C002','B008','C003'),('C003','B008','C003');
#통장 테이블 
#statistic table 생성
