...
public class JFrameBarChartForCardDaily {
	...
	private static ObservableList<XYChart.Series<String, Number>> getChartData() throws SQLException {
		...
		Info data1 = service.cardInfoDaily("김가나");
		Info data2 = service.cardInfoDaily("김다라");
		Info data3 = service.cardInfoDaily("김마바");
		Info data4 = service.cardInfoDaily("김사아");
		Info data5 = service.cardInfoDaily("김자차");
