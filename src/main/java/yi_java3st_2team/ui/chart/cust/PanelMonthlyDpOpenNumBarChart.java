...
public class PanelMonthlyDpOpenNumBarChart extends JFXPanel implements InitScene{
	public PanelMonthlyDpOpenNumBarChart() {
	}
	...
	private ObservableList<XYChart.Series<String, Number>> getChartData() {
		...
		List<String> listDp = new ArrayList<>();//예금건수
		List<String> listZero = null;
		
		try {
			listDp = service.showOpenDPMonth();
