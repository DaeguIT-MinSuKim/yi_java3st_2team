...
public class JFrameBarChartForBankBookDaily {
	...
	private static ObservableList<XYChart.Series<String, Number>> getChartData() throws SQLException {
		...
		Info data1 = service.bankBookInfoDaily("김가나");
		Info data2 = service.bankBookInfoDaily("김다라");
		Info data3 = service.bankBookInfoDaily("김마바");
		Info data4 = service.bankBookInfoDaily("김사아");
		Info data5 = service.bankBookInfoDaily("김자차");
