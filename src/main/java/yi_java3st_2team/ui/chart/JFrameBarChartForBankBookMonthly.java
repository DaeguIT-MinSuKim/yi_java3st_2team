...
public class JFrameBarChartForBankBookMonthly {
	...
	private static ObservableList<XYChart.Series<String, Number>> getChartData() throws SQLException {
		...
		Info data1 = service.bankBookInfoMonthly("김가나");
		Info data2 = service.bankBookInfoMonthly("김다라");
		Info data3 = service.bankBookInfoMonthly("김마바");
		Info data4 = service.bankBookInfoMonthly("김사아");
		Info data5 = service.bankBookInfoMonthly("김자차");
