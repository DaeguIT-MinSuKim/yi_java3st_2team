...
public class JFrameBarChartForCardYearly {
	...
	private static ObservableList<XYChart.Series<String, Number>> getChartData() throws SQLException {
		...
		Info data1 = service.cardInfoYearly("김가나");
		Info data2 = service.cardInfoYearly("김다라");
		Info data3 = service.cardInfoYearly("김마바");
		Info data4 = service.cardInfoYearly("김사아");
		Info data5 = service.cardInfoYearly("김자차");
