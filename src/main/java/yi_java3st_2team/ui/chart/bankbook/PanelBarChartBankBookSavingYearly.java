...
public class PanelBarChartBankBookSavingYearly extends JFXPanel implements InitScene{
	private BarChart<String, Number> barChart;
	private BankBookService service;
	public PanelBarChartBankBookSavingYearly() {
	...
	public Scene createScene() {
		...
		barChart.setTitle("고객별 적금 연간 거래 내역 조회");
