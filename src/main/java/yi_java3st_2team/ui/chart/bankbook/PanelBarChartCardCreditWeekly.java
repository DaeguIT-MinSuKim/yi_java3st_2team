...
public class PanelBarChartCardCreditWeekly extends JFXPanel implements InitScene{
	private BarChart<String, Number> barChart;
	private CardService service;
	public PanelBarChartCardCreditWeekly() {
	...
	public Scene createScene() {
		...
		barChart.setTitle("고객별 신용카드 주간 거래 내역 조회");
	...
	private ObservableList<XYChart.Series<String, Number>> getChartData() {
		...
		try {
			infoList = service.cardInfoWeekly();
