...
public class PanelBarChartCardCreditYearly extends JFXPanel implements InitScene{
	private BarChart<String, Number> barChart;
	private CardService service;
	public PanelBarChartCardCreditYearly() {
	...
	public Scene createScene() {
		...
		barChart.setTitle("고객별 신용카드 연간 거래 내역 조회");
	...
	private ObservableList<XYChart.Series<String, Number>> getChartData() {
		...
		try {
			list1 = service.cardInfoYearly("김가나");
			list2 = service.cardInfoYearly("김다라");
			list3 = service.cardInfoYearly("김마바");
			list4 = service.cardInfoYearly("김사아");
			list5 = service.cardInfoYearly("김자차");
			if(list1.size()==0) {
