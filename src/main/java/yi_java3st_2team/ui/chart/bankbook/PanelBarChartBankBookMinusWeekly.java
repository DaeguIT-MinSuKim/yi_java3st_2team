...
public class PanelBarChartBankBookMinusWeekly extends JFXPanel implements InitScene{
	private BarChart<String, Number> barChart;
	private BankBookService service;
	public PanelBarChartBankBookMinusWeekly() {
	...
	public Scene createScene() {
		...
		barChart.setTitle("고객별 마이너스통장 주간 거래 내역 조회");
