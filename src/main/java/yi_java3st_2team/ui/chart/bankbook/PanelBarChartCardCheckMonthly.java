...
public class PanelBarChartCardCheckMonthly extends JFXPanel implements InitScene{
	private BarChart<String, Number> barChart;
	private CardService service;
	public PanelBarChartCardCheckMonthly() {
	...
	public Scene createScene() {
		...
		barChart.setTitle("고객별 체크카드 월간 거래 내역 조회");
