...
public class PanelBarChartCardCheckYearly extends JFXPanel implements InitScene{
	private BarChart<String, Number> barChart;
	private CardService service;
	public PanelBarChartCardCheckYearly() {
	...
	public Scene createScene() {
		...
		barChart.setTitle("고객별 체크카드 연간 거래 내역 조회");
