...
public class PanelBarChartBankBookSavingWeekly extends JFXPanel implements InitScene{
	private BarChart<String, Number> barChart;
	private BankBookService service;
	public PanelBarChartBankBookSavingWeekly() {
	...
	public Scene createScene() {
		...
		barChart.setTitle("고객별 적금 주간 거래 내역 조회");
	...
	private ObservableList<Series<String, Number>> getChartData() {
		...
		try {
			infoList = service.bankBookInfoWeekly();
