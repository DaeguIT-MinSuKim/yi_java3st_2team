...
public class JFrameBarChartForBankBookYearly {
	...
	private static ObservableList<XYChart.Series<String, Number>> getChartData() throws SQLException {
		...
		Info data1 = service.bankBookInfoYearly("김가나");
		Info data2 = service.bankBookInfoYearly("김다라");
		Info data3 = service.bankBookInfoYearly("김마바");
		Info data4 = service.bankBookInfoYearly("김사아");
		Info data5 = service.bankBookInfoYearly("김자차");
