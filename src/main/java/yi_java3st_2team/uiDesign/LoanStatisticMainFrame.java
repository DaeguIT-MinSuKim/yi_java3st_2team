...
public class LoanStatisticMainFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LoanStatisticMainFrame frame = new LoanStatisticMainFrame();
	...
	private void initialize() {
		...
		pcNorth.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
		...
		lblNewLabel_3.setIcon(new ImageIcon(new ImageIcon("D:\\workspace_gradle\\yi_java3st_2team\\images\\mLogo.png").getImage().getScaledInstance(540, 250, 1)));
		...
		label_5.setForeground(new Color(254,208,64));
