...
public class LoanInfoStatisticFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LoanInfoStatisticFrame frame = new LoanInfoStatisticFrame();
