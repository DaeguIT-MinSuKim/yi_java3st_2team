...
public class BankBookTransHisStatisticFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BankBookTransHisStatisticFrame frame = new BankBookTransHisStatisticFrame();
	 ...
	 * Create the frame.
	 */
	public BankBookTransHisStatisticFrame() {
		initialize();
	}
