...
public class BankWorkMainFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BankWorkMainFrame frame = new BankWorkMainFrame();
	...
	private void initialize() {
		...
		lblNewLabel_3.setIcon(new ImageIcon(new ImageIcon("D:\\workspace_gradle\\yi_java3st_2team\\images\\mLogo.png").getImage().getScaledInstance(500, 300, 1)));
