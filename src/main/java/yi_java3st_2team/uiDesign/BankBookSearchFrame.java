...
public class BankBookSearchFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BankBookSearchFrame frame = new BankBookSearchFrame();
		...
		ActionListener popListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getActionCommand().equals("추가")) {
					dlgBook.setTitle("통장 " + e.getActionCommand());
					dlgBook.setModal(true);
