...
public class CustomerItemSearchFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CustomerItemSearchFrame frame = new CustomerItemSearchFrame();
	 ...
	 * Create the frame.
	 */
	public CustomerItemSearchFrame() {
		initialize();
	}
	private void initialize() {
		...
		lblNewLabel_3 = new JLabel("상품명 입력");
		...
		ActionListener popListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getActionCommand().equals("추가")) {
					dlgItem.setTitle("상품 " + e.getActionCommand());
					dlgItem.setModal(true);
