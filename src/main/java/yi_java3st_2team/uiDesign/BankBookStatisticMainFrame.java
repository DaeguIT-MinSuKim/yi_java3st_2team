...
public class BankBookStatisticMainFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BankBookStatisticMainFrame frame = new BankBookStatisticMainFrame();
	 ...
	 * Create the frame.
	 */
	public BankBookStatisticMainFrame() {
		initialize();
	}
	private void initialize() {
		...
		label_8 = new JLabel("통장 거래 내역 조회");
