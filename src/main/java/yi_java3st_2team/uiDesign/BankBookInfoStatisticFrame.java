...
public class BankBookInfoStatisticFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BankBookInfoStatisticFrame frame = new BankBookInfoStatisticFrame();
	 ...
	 * Create the frame.
	 */
	public BankBookInfoStatisticFrame() {
		initialize();
	}
	private void initialize() {
		...
		lblNewLabel_3 = new JLabel("입출금 건수");
